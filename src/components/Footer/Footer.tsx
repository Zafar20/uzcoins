...
import { tg, whatsapp, number, arrowUp } from '@/utils/images'
...
let socials = [
  {img: tg, url: 'https://t.me/Uzcoins_sum'},
  {img: whatsapp, url: 'https://wa.me/+998979951611'},
]
          ...
          <div className={s.footer__info_bottom}>
           {socials.map((el, i) => (
            <a key={i} href={el.url}  className={s.footer__info_bottom_link}>
              <Image src={el.img} alt="" width={20} height={20} />
            </a>
           ))}
          </div>
        </div>
