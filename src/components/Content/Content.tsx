      ...
      <div className="container h100">
        <div className={s.content__block}>
          <div className={s.content__block_left}>
            ...
            <a  target="_blank" href="https://pr.uz/cb-predstavil-monety-s-polkovodczem-manguberdy/?ysclid=lyl716zl18245254594" className={s.content__block_left_link}>{t('link')}</a>
          </div>
